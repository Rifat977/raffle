            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.referral.index') }}">
                    <a class="nav-link" href="{{ route('admin.referral.index') }}">
                        ...
                        <span class="menu-title">@lang('Manage Referrals')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.lottery*', 3) }}" href="javascript:void(0)">
                        ...
                        @if ($waitingManualForDrawCount > 0)
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.lottery*', 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.lottery.phases') }}">
                                <a class="nav-link" href="{{ route('admin.lottery.phases') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Lottery Phases')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.lottery.draw.manual') }}">
                                <a class="nav-link" href="{{ route('admin.lottery.draw.manual') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Manual Draw')</span>
                                    @if ($waitingManualForDrawCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $waitingManualForDrawCount }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.commissions.deposit') }}">
                                <a class="nav-link" href="{{ route('admin.report.commissions.deposit') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Commission Log')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.report.lottery.ticket') }}">
                                <a class="nav-link" href="{{ route('admin.report.lottery.ticket') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Sold Ticket Log')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.report.winners') }}">
                                <a class="nav-link" href="{{ route('admin.report.winners') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Winner Log')</span>
                                </a>
                            </li>
