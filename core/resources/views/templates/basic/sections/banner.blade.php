    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-7 col-xl-8 col-lg-10 text-center">
                ...
                <a class="btn btn--base btn--capsule wow fadeInUp mt-4 text-dark" data-wow-duration="0.5s" data-wow-delay="0.7s" href="{{ @$banner->data_values->button_url }}">{{ __(@$banner->data_values->button_name) }}</a>
            </div>
        </div>
    </div>
</section>
