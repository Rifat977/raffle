            ...
            @foreach ($testimonials as $testimonial)
                <div class="single-slide shadow">
                    <div class="testimonial-item rounded-3">
                        ...
                        <p class="mt-2 text-light">{{ __(@$testimonial->data_values->review) }}</p>
                        <div class="client-details d-flex align-items-center mt-4">
                            ...
                            <div class="content">
                                <h4 class="name text-light">{{ __(@$testimonial->data_values->name) }}</h4>
                                <span class="designation text-light-50 fs--14px">{{ __(@$item->data_values->designation) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
