        ...
        <div class="container-fluid px-lg-5">
            <nav class="navbar navbar-expand-xl align-items-center p-0">
                ...
                <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
                    <ul class="navbar-nav main-menu me-auto" style="justify-content:center; align-items:center; width:70%;">
...
<?php /**PATH /srv/http/Files/core/resources/views/templates/basic/partials/header.blade.php ENDPATH**/ ?>