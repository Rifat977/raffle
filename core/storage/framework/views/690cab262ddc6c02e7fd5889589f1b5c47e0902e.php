    ...
    <section class="pt-100 pb-50">
        <div class="container">
            <div class="row justify-content-between gy-5">
                <div class="col-lg-4">
                    <h2 class="mb-3 text-dark"><?php echo e(__(@$contact->data_values->title)); ?></h2>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/http/Files/core/resources/views/templates/basic/contact.blade.php ENDPATH**/ ?>