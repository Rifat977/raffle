            ...
            <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="single-slide shadow">
                    <div class="testimonial-item rounded-3">
                        ...
                        <p class="mt-2 text-light"><?php echo e(__(@$testimonial->data_values->review)); ?></p>
                        <div class="client-details d-flex align-items-center mt-4">
                            ...
                            <div class="content">
                                <h4 class="name text-light"><?php echo e(__(@$testimonial->data_values->name)); ?></h4>
                                <span class="designation text-light-50 fs--14px"><?php echo e(__(@$item->data_values->designation)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /srv/http/Files/core/resources/views/templates/basic/sections/testimonial.blade.php ENDPATH**/ ?>