                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                    <div class="feature-card rounded-3">
                        ...
                        <div class="feature-card__content mt-4">
                            ...
                            <p class="mt-3 text-light"><?php echo e(__(@$feature->data_values->description)); ?></p>
                        </div>
...
<!-- feature section end -->
<?php /**PATH /srv/http/Files/core/resources/views/templates/basic/sections/feature.blade.php ENDPATH**/ ?>