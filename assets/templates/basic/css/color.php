...
$color = "#f4f5f7"; // Change your Color Here
$secondColor = "#f4f5f7"; // Change your Color Here
...
.pagination .page-item .page-link, .recent-winner-card {
...
.how-work-card__step, .recent-winner-card {
...
background-color: <?php echo $color ?>/ 0.2);
...
.winner-card:hover , .recent-winner-card:hover{
box-shadow: 0 5px 15px <?php echo $color ?>40, inset 0 0 15px <?php echo $color ?>d9;
border-color: <?php echo $color ?>;
}
